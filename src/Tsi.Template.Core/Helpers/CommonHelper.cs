...
namespace Tsi.Template.Core.Helpers
{
    public class CommonHelper
    {
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            if (pi == null)
            {
                throw new ApplicationException($"No property '{propertyName}' found on the instance of type '{instanceType}'.");
            }

            if (!pi.CanWrite)
            {
                throw new ApplicationException("The property '{propertyName}' on the instance of type '{instanceType}' does not have a setter." );
            }
